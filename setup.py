...
setup(
    ...
    version="1.0.0",
    author="Kylie Smith",
    author_email="kylie.smithy01@gmail.com",
    description="The PyPlayground open-source game engine",
    long_description="",
    packages=["pyplayground", "pyplayground.core", "pyplayground.render", "pyplayground.task"],
    package_dir={"pyplayground": "src_py"},
    ext_modules=[CMakeExtension("PyPlayground")],
    cmdclass={"build_ext": CMakeBuild},
    zip_safe=False,
    extras_require={"test": ["pytest>=7.2.0", "black>=22.10.0"]},
